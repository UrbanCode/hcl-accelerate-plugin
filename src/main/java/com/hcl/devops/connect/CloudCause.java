...
import com.hcl.devops.connect.Status.DRAData;
import com.hcl.devops.connect.Status.SourceData;
...
public class CloudCause extends Cause {
    ...
    public String getShortDescription() {
        return "Started due to a request from HCL Accelerate. Work Id: " + this.workId;
    }

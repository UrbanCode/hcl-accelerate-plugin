...
public class UploadBuild extends Builder implements SimpleBuildStep {
    ...
    throws AbortException, InterruptedException, IOException {
        ...
        List<Entry> finalEntriesList = CloudPublisher.getFinalEntriesList("Upload Build", instanceBaseUrl, getEntries());
    ...
    public static class UploadBuildDescriptor extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "HCL Accelerate - Upload Build to HCL Accelerate";
        }
